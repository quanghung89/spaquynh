                  ...
                  success: function(data)
                  {
                      if(data){
                          $.each(data,function(k,v){
                            ...
                            if(!v.avatar){
                              v.avatar = "assets/images/"+v.gender +".png ";
                            }else{
                            ...
                            if(v.status_active == 1){
                              option1 += '<div class="status_active1 col-xs-12" value="'+ v.id +'">' + '<img alt="" src="'+ v.avatar +'" class="avatar">' +'<span><i class="status_active status_active1a">a(</i>'+ v.last_name + v.class +'</span>' + '</div>';
                            }else if(v.status_active == 2){
                              option2 += '<div class="status_active2 col-xs-12" value="'+ v.id +'">' + '<img alt="" src="'+ v.avatar +'" class="avatar">' + '<span><i class="status_active status_active2a">a(</i>'+ v.last_name + v.class +'</span>' + '</div>';
                            }else if(v.status_active == 4){
                              option4 += '<div class="status_active4 col-xs-12" value="'+ v.id +'">' + '<img alt="" src="'+ v.avatar +'" class="avatar">' + '<span><i class="status_active status_active4a">a(</i>'+ v.last_name + v.class +'</span>' + '</div>';
                            }else{
                              option3 += '<div class="status_active3 col-xs-12" value="'+ v.id +'">' + '<img alt="" src="'+ v.avatar +'" class="avatar">' + '<span><i class="status_active status_active3a">a(</i>'+ v.last_name + v.class +'</span>' + '</div>';
                            } 
                          })
