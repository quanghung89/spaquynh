            ...
            <script>
               ...
               $(document).ready(function () {
                   ...
                   var initParams = {
                       ...
                       "aoColumns": [{"mRender": text_center}, null,null,{"mRender": text_center}, {"bSortable": false}]
               ...
               <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-left: 0px;">
                  <div class="input-group " >
                    ...
                    <table id="Timeout" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <!-- <tbody>
                            <?php $i=1; foreach ($timeouts as $key => $value) { ?>
                                <tr class="text-center">
                                    <td ><?php echo $i ?></td>
                                    <td><?php echo $this->sma->ihrsd($value['sma_timeout_startdate']) ?>
                                    </td>
                                    <td class="data-enday"><?php echo $this->sma->ihrsd($value['sma_timeout_enddate']) ?>
                                    </td>
                                    <td><?php echo $value['sma_timeout_day'] ?>
                                    </td>
                                    <?php if($Owner || $Admin){ ?>
                                        <td style="width:85px;">
                                            <a href="#" class="tip bpo"
                                                 title="<b><?= $this->lang->line("Xóa ngày nghỉ") ?></b>"
                                                 data-content="<div style='width:220px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?php echo site_url("auth/delete_timeout/".$user->id.'/'.$value["sma_timeout_id"]) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>"
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 10px;">   
                                    ...
                                    <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12" style="margin: 0px;">
                                        <label>Lương/Ngày công (Ngày)</label>
